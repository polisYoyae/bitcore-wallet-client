 ...
 *
 * @param {string} coin - 'polis' (default) or 'bch'
...
API.prototype.getFeeLevels = function(coin, network, cb) {
  ...
  $.checkArgument(coin || _.includes(['polis', 'bch'], coin));
...
API.prototype.createWallet = function(walletName, copayerName, m, n, opts, cb) {
  ...
  var coin = opts.coin || 'polis';
  if (!_.includes(['polis', 'bch'], coin)) return cb(new Error('Invalid coin'));
...
API.prototype.getBalance = function(opts, cb) {
  ...
  if (opts.coin) {
    if (!_.includes(['polis', 'bch'], opts.coin)) return cb(new Error('Invalid coin'));
