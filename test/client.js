...
helpers.toSatoshi = function(polis) {
  if (_.isArray(polis)) {
    ...
    return parseFloat((polis * 1e8).toPrecision(12));
  }
};
...
describe('client API', function() {
  ...
  describe('Build & sign txs', function() {
    ...
    describe('#signTxp', function() {
      ...
      it('should sign polis proposal correctly', function() {
        var toAddress = 'yie4Ubd2ieCdzqwNyAc8QRutfri3E9ChTm';
  ...
  describe('Network fees', function() {
    it('should get current fee levels for POLIS', function(done) {
      ...
      clients[0].credentials = {};
      clients[0].getFeeLevels('polis', 'livenet', function(err, levels) {
        should.not.exist(err);
        should.exist(levels);
  ...
  describe('Transaction Proposal signing', function() {
    ...
    describe('POLIS', function(done) {
      beforeEach(function(done) {
        setup(2, 3, 'polis', 'testnet', done);
      });
  ...
  var addrMap = {
    polis: ['XdZgN4xhXASx1UKdnnDV9RXCaLCqnvDmZp','XoJGPKstMm965AmVzsBZG71HWMEU6CMpMq'],
